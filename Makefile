...
bctrm3_mfg_config \
bctrm3_config	: unconfig
	@[ -z "$(findstring iram_,$@)" ] || \
		{ echo "TEXT_BASE = 0x00907000" >$(obj)board/freescale/bctrm3/config.tmp ; \
		  echo "... with iram configuration" ; \
		}
...
bctre3_config	: unconfig
	@[ -z "$(findstring iram_,$@)" ] || \
		{ echo "TEXT_BASE = 0x00907000" >$(obj)board/freescale/bctre3/config.tmp ; \
		  echo "... with iram configuration" ; \
		}
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 bctre3 freescale mx6
