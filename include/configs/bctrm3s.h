...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"digon_setup=i2c mw 56 09 01\0"\
		"video_args=mxcfb0:dev=ldb,LDB-SVGA,if=RGB24 video=mxcfb1:dev=hdmi,1280x720M@60,if=RGB24\0"	\
		"bootargs_base=run digon_setup ; setenv bootargs console=ttymxc2,115200 video=${video_args} \0"\
...
#define CONFIG_SYS_PROMPT		"BCT-RM3S U-Boot > "
 ...
 */
	...
	/* SD1 (device 0) is 4-bit, SD3 (device 1) is 8 bit */
	#define CONFIG_MMC_8BIT_PORTS   0x02
