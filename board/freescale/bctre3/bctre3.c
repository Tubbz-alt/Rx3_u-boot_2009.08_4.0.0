...
{
	/* UART1 RXD */
	mxc_iomux_v3_setup_pad(MX6Q_PAD_SD3_DAT6__UART1_RXD); //CON_UART3_RX 
	/* UART1 TXD */
	mxc_iomux_v3_setup_pad(MX6Q_PAD_SD3_DAT7__UART1_TXD); //CON_UART3_TX
...
int board_init(void)
{
	...
	/* board id for linux */
	gd->bd->bi_arch_number = MACH_TYPE_BCTRE3;
...
void enet_board_init(void)
{
	...
	/* phy reset: gpio7-6 */
	set_gpio_output_val(GPIO7_BASE_ADDR, (1 << 6), 1);
	...
	udelay(500);
	set_gpio_output_val(GPIO7_BASE_ADDR, (1 << 6), 0);
